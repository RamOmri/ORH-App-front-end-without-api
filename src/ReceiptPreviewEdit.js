...
static navigationOptions = {
  ...
  state = {
        number: this.props.navigation.getParam('code'),
  ...
  render() {
    ...
    > 
            <View style = {{alignItems: 'center'}}>
               <Text style = {styles.screen_title}>{this.props.navigation.getParam('code')}</Text> 
            </View>
            <View style = {{ alignContent: 'center', justifyContent: 'center', alignItems:'center'}}>
                ...
                <View style = {{flexDirection: 'row'}}>
                    ...
                    onPress={() =>{
                     this.props.navigation.navigate('ReceiptPreview', {delete: false, quan: this.state.quantity, edit: true})
                    }}
                >           
