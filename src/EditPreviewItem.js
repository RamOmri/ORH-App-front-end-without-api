...
export default class EditPreviewItem extends React.Component {
static navigationOptions = {
  ...
  state = {
    ...
    ConfirmEdit(){
                            ...
                            this.props.navigation.navigate('StockPreview', {delete: false, quan: this.state.quantity, edit: true, addedItem: false})
    ...
    > 
            ...
            <View style = {{ alignContent: 'center', justifyContent: 'center', alignItems:'center'}}>
                ...
                <View style = {{flexDirection: 'row'}}>
                    ...
                    onPress={() =>{
                        this.props.navigation.navigate('StockPreview', {delete: true, quan: this.state.quantity, edit: false, addedItem: false})
                    }}
                >           
